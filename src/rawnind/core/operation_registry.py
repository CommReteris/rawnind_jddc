...
class OperationRegistry:
    ...
    def register_implementation(
        self, name: str, implementation: Type[PipelineOperation]
    ):
    ...
    def find_compatible_operations(
        self, source_op: str, position: str = "after"
    ) -> List[str]:
    ...
    def get_pipeline_path(
        self, start_type: TensorType, end_type: TensorType
    ) -> List[List[str]]:
...
def register_default_operations():
    ...
    OPERATION_REGISTRY.register_spec(
        OperationSpec(
            name="raw_loader",
            category="input",
